...
To confirm our guess, we also created a table that counts the number of TV shows that are less popular (have less than 100 votes on IMDb) and the number of production companies that are given credits to.
